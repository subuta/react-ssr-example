...
/* eslint-disable */
const PageBazFoo = loadable(async () => delay(import('./baz/foo')).catch(onImportError), { render: renderLoadable })
const PageNyan = loadable(async () => delay(import('./nyan')).catch(onImportError), { render: renderLoadable })
const PageBar = loadable(async () => delay(import('./bar')).catch(onImportError), { render: renderLoadable })
const PageBarHoge = loadable(async () => delay(import('./bar/hoge')).catch(onImportError), { render: renderLoadable })
const PageBaz = loadable(async () => delay(import('./baz')).catch(onImportError), { render: renderLoadable })
const PageFoo = loadable(async () => delay(import('./foo')).catch(onImportError), { render: renderLoadable })
